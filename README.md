...
This is a proof-of-concept implementation of a small fragment of an English Sign-Based Construction Grammar, adapted to adhere to classic
...
The grammar file "g.fit" was written by Rui P. Chaves (rchaves@buffalo.edu) at the University at Buffalo, SUNY. After loading SICSStus, the interpreter must be loaded:
